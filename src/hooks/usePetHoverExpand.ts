...
// hover the pet 300ms → window grows rightward, info card appears
// beside the pet (right side). Leave → 1s linger → shrink back.
// Height stays constant so the capsule never clips text vertically.
